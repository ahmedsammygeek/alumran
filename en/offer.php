			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8">
						...
						<p>
							<a href="reservation2.php?id=<?php echo $details->id; ?>" data-hotel-id='<?php echo $details->id; ?>' class="btn btn-primary" >Book This Hotel</a>
							<a href="offers.php"  class="btn btn-default">View Other Rooms</a>
						</p>
					</div>
					<div class="col-sm-4">
