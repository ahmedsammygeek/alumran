...
$news = $conn->prepare("SELECT * FROM clients");
$news->execute();
        ...
        <div class="row">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">أدارة عملاء الموقع </h3>
                </div>
                <div class="box-footer">
                    <a  href="add_client.php" class="btn btn-info pull-right ">اضف عميل جديد</a>
                    <br>
                </div>
                    ...
                    <table dir="rtl" id="tasks" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            while ($new = $news->fetch(PDO::FETCH_OBJ)) {
                                echo '<tr>
                                <td>'.$i.'</td>
                                <td> <img src="../uploaded/clients/'.$new->image.'" width="200" height="100" alt=""> </td>
                                <td>'.$new->link.'</td>
                                
                                
                                <td><a href="delete_client.php?id='.$new->id.'&img='.$new->image.'" class="btn btn-danger">خذف</a></td>
                                </tr>';
                                $i++;
                            }
                            ?>
