        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box">
                 ...
                 ?>
                 <div class="row">
                   <form action="insert_work.php" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">

                        <div class="form-group">
                            <label for="exampleInputEmail1">صورة المشروع </label>
                            <input type="file" name="work_pic" id="input" class="form-control"   >
                        </div>                         
                    </div>
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1"> تفاصيل المشروع (نبذة)</label>
                           <input type="text" name="content_ar" id="input" class="form-control"   >
                        </div>
                    </div>
                    <div class="col-md-12">
