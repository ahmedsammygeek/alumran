 ...
 <?php 
                ...
                <div class="box">
                    ...
                    <div class="box-footer">
                        <a  href="add_news.php" class="btn btn-info pull-right ">اضف خبر جديد</a>
                        <br>
                    </div>
                        ...
                        <table dir="rtl" id="tasks" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                while ($new = $news->fetch(PDO::FETCH_OBJ)) {
                                    ...
                                    <td>'.$new->title_ar.'</td>
                                    <td>'.$new->date.'</td>
                                    <td><a href="edit_news.php?id='.$new->id.'&img='.$new->image.'" class="btn btn-warning">تعديل</a></td>
                                    <td><a href="delete_news.php?id='.$new->id.'&img='.$new->image.'" class="btn btn-danger">خذف</a></td>
                                </tr>';
                                $i++;
                                }
                                 ?>
