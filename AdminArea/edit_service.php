...
if(isset($_GET['id'], $_GET['img']) && !empty($_GET['id']) ) {
    ...
    $select = $conn->prepare("SELECT * FROM services WHERE id = ? ");
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    ?>
                    <div class="row">
                       <form action="update_service.php?id=<?php echo $id.'&img='.$topic->image ; ?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-10">
                            <label for="">  الصورة الحالية </label>
                            <br>
                            <?php 
                            if(isset($topic->image)) {
                                echo '<img src="../uploaded/services/'.$topic->image.'" width="300" height="300" class="img-thumbnail">';
                            }
                            ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="content_ar" value="<?php echo $topic->content_ar ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">   المحتوى </label>
                                <input type="text" class="form-control" name="content" value="<?php echo $topic->content ?>" >
                        ...
                        <div class="box-footer">
                            <input type="submit" name="goo" class="btn btn-success pull-right" value="تعديل الخدمة">
                        </div>
                    </form>
                </div>
